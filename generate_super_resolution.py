...
This program generates the super resolution image of given low resolution image based on the
model provided by user with its trained upscale factor.
"""
...
print("!! May Gives Warning if the model.py code is modified after the model file, which used to give input, is generated.\n")
model = torch.load(opt.model)
print("\n But No Worries!! Output is generating....\n")
